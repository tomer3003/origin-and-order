...
export const FEATS = {
  ...
  skilled: {
    ...
    text: "Proficiency in any three skills or tools of your choice. (Tool proficiencies aren't tracked here — pick skills for any of the three you'd spend on a tool.)",
    skillChoiceAny: 3
  },
  tavernBrawler: {
  ...
  actor: {
    ...
    prereqFn: (s) => s.cha >= 13, abilityChoice: ["cha"],
  ...
  chef: {
    name: "Chef", category: "general", abilityChoice: ["con", "wis"],
  ...
  crossbowExpert: {
    ...
    prereqFn: (s) => s.dex >= 13, abilityChoice: ["dex"],
  ...
  crusher: {
    name: "Crusher", category: "general", abilityChoice: ["str", "con"],
  ...
  durable: {
    name: "Durable", category: "general", abilityChoice: ["con"],
  ...
  greatWeaponMaster: {
    ...
    prereqFn: (s) => s.str >= 13, abilityChoice: ["str"],
  ...
  heavilyArmored: {
    name: "Heavily Armored", category: "general", prereq: "Medium armor training", abilityChoice: ["str"],
    text: "+1 Strength (max 20) and Heavy armor training."
  },
  heavyArmorMaster: {
    name: "Heavy Armor Master", category: "general", prereq: "Heavy armor training", abilityChoice: ["str"],
  ...
  inspiringLeader: {
    name: "Inspiring Leader", category: "general", abilityChoice: ["wis", "cha"],
  ...
  keenMind: {
    name: "Keen Mind", category: "general", abilityChoice: ["int"],
  ...
  lightlyArmored: {
    name: "Lightly Armored", category: "general", abilityChoice: ["str", "dex"],
    text: "+1 Strength or Dexterity (max 20) and Light armor training."
  },
  mageSlayer: {
    name: "Mage Slayer", category: "general", abilityChoice: ["str", "dex"],
  ...
  martialWeaponTraining: {
    name: "Martial Weapon Training", category: "general", abilityChoice: ["str", "dex"],
    text: "+1 Strength or Dexterity (max 20) and Martial weapon proficiency."
  },
  mediumArmorMaster: {
    name: "Medium Armor Master", category: "general", prereq: "Medium armor training", abilityChoice: ["str", "dex"],
    text: "+1 Strength or Dexterity (max 20), Medium armor no longer hampers Stealth, and it allows up to +3 Dex to AC."
  },
  moderatelyArmored: {
    name: "Moderately Armored", category: "general", prereq: "Light armor training", abilityChoice: ["str", "dex"],
    text: "+1 Strength or Dexterity (max 20), plus Medium armor and Shield training."
  },
  mountedCombatant: {
    name: "Mounted Combatant", category: "general", abilityChoice: ["str", "dex", "wis"],
  ...
  observant: {
    ...
    prereqFn: (s) => s.int >= 13 || s.wis >= 13, abilityChoice: ["int", "wis"],
    skillChoiceFrom: ["insight", "investigation", "perception"],
  ...
  piercer: {
    name: "Piercer", category: "general", abilityChoice: ["str", "dex"],
  ...
  resilient: {
    name: "Resilient", category: "general", abilityChoice: "any", tiesSaveProf: true,
  ...
  shieldMaster: {
    name: "Shield Master", category: "general", prereq: "Shield training", abilityChoice: ["str"],
  ...
  skillExpert: {
    name: "Skill Expert", category: "general", abilityChoice: "any",
    skillChoiceAny: 1, expertiseChoiceAny: 1,
  ...
  slasher: {
    name: "Slasher", category: "general", abilityChoice: ["str", "dex"],
  ...
  speedy: {
    ...
    prereqFn: (s) => s.dex >= 13 || s.con >= 13, abilityChoice: ["dex", "con"],
  ...
  warCaster: {
    name: "War Caster", category: "general", prereq: "Spellcasting or Pact Magic", abilityChoice: ["int", "wis", "cha"],
  ...
  boonIrresistibleOffense: {
    name: "Boon of Irresistible Offense", category: "boon", abilityChoice: ["str", "dex"],
  ...
  boonRecovery: {
    name: "Boon of Recovery", category: "boon", abilityChoice: "any",
  ...
  boonNightSpirit: {
    name: "Boon of the Night Spirit", category: "boon", abilityChoice: "any",
  ...
  boonTruesight: {
    name: "Boon of Truesight", category: "boon", abilityChoice: "any",
